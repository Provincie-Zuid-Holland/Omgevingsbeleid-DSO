...
from dso.act_builder.services.ow.ow_builder import OwBuilder
...
class Builder:
    ...
    def get_ow_state(self) -> OwState:
        if self._state_manager.output_ow_state is None:
            raise RuntimeError("Expected OW State result to be set in state manager.")
        return self._state_manager.output_ow_state
