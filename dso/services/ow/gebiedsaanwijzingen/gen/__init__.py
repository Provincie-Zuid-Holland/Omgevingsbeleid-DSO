...
ga_energievoorzieninggroep_groep = Gebiedsaanwijzing(
    ...
    waardes=[
        GebiedsaanwijzingWaarde(
            label="all-electric",
            term="AllElectric",
            uri="http://standaarden.omgevingswet.overheid.nl/energievoorziening/id/concept/AllElectric",
            definitie="Waarde voor attribuut groep bij het Gebiedsaanwijzingtype Energievoorziening t.b.v. het in een warmteprogramma binnen een toegedacht warmtetransitiegebied aanwijzen van een gebied waar all-electric de toegedachte energie-infrastructuur is.",
            toelichting="",
            bron="",
        ...
        GebiedsaanwijzingWaarde(
            label="combinatie van technieken",
            term="CombinatieVanTechnieken",
            uri="http://standaarden.omgevingswet.overheid.nl/energievoorziening/id/concept/CombinatieVanTechnieken",
            definitie="Waarde voor attribuut groep bij het Gebiedsaanwijzingtype Energievoorziening t.b.v. het in een warmteprogramma binnen een toegedacht warmtetransitiegebied aanwijzen van een gebied waar een combinatie van technieken is toegedacht, nog onzeker is welke energie-infrastructuur gekozen gaat worden of wel duidelijk is dat in delen van een wijk verschillende energie-infrastructuren gekozen zullen worden maar de precieze grens nog niet te bepalen is.",
            toelichting="",
            bron="",
            domein="http://standaarden.omgevingswet.overheid.nl/id/conceptscheme/Energievoorziening",
            deprecated=False,
        ...
        GebiedsaanwijzingWaarde(
            label="klimaatneutraal gas",
            term="KlimaatneutraalGas",
            uri="http://standaarden.omgevingswet.overheid.nl/energievoorziening/id/concept/KlimaatneutraalGas",
            definitie="Waarde voor attribuut groep bij het Gebiedsaanwijzingtype Energievoorziening t.b.v. het in een warmteprogramma binnen een toegedacht warmtetransitiegebied aanwijzen van een gebied waar klimaatneutraal gas de toegedachte energie-infrastructuur is.",
            toelichting="",
            bron="",
            domein="http://standaarden.omgevingswet.overheid.nl/id/conceptscheme/Energievoorziening",
            deprecated=False,
        ...
        GebiedsaanwijzingWaarde(
            label="warmtenet",
            term="Warmtenet",
            uri="http://standaarden.omgevingswet.overheid.nl/energievoorziening/id/concept/Warmtenet",
            definitie="Waarde voor attribuut groep bij het Gebiedsaanwijzingtype Energievoorziening t.b.v. het in een warmteprogramma binnen een toegedacht warmtetransitiegebied aanwijzen van een gebied waar een warmtenet de toegedachte energie-infrastructuur is.",
            toelichting="",
            bron="",
            domein="http://standaarden.omgevingswet.overheid.nl/id/conceptscheme/Energievoorziening",
            deprecated=False,
...
ga_functiegroep_groep = Gebiedsaanwijzing(
    ...
    waardes=[
        GebiedsaanwijzingWaarde(
            ...
            definitie="Waarde voor attribuut groep bij het Gebiedsaanwijzingtype Functie t.b.v. het aanwijzen en begrenzen van en stellen van regels over aandachtsgebieden, niet zijnde aandachtsgebieden externe veiligheid, geluid, lucht of trilling.",
            toelichting="",
            bron="https://wetten.overheid.nl/BWBR0041313",
        ...
        GebiedsaanwijzingWaarde(
            label="aandachtsgebied trilling",
            term="AandachtsgebiedTrilling",
            uri="http://standaarden.omgevingswet.overheid.nl/functie/id/concept/AandachtsgebiedTrilling",
            definitie="Waarde voor attribuut groep bij het Gebiedsaanwijzingtype Functie t.b.v. het aanwijzen en begrenzen van en stellen van regels over een aandachtsgebied m.b.t. trilling.",
            toelichting="Groep te gebruiken voor bijvoorbeeld het trillingaandachtsgebied spoor: het gebied langs een spoorweg waarbinnen de gemeente specifieke regels stelt voor het toelaten van trillinggevoelige gebouwen.",
            bron="https://www.geonovum.nl/geo-standaarden/omgevingswet/STOPTPOD",
            domein="http://standaarden.omgevingswet.overheid.nl/id/conceptscheme/Functie",
            deprecated=False,
        ),
        ...
        GebiedsaanwijzingWaarde(
            label="all-electric",
            term="AllElectric",
            uri="http://standaarden.omgevingswet.overheid.nl/functie/id/concept/AllElectric",
            definitie="Waarde voor attribuut groep bij het Gebiedsaanwijzingtype Functie t.b.v. het in het omgevingsplan binnen een warmtetransitiegebied aanwijzen en begrenzen van en stellen van regels over een gebied waar all-electric de voorgeschreven energie-infrastructuur is.",
            toelichting="",
            bron="",
            domein="http://standaarden.omgevingswet.overheid.nl/id/conceptscheme/Functie",
            deprecated=False,
        ...
        GebiedsaanwijzingWaarde(
            label="warmtenet",
            term="Warmtenet",
            uri="http://standaarden.omgevingswet.overheid.nl/functie/id/concept/Warmtenet",
            definitie="Waarde voor attribuut groep bij het Gebiedsaanwijzingtype Functie t.b.v. het in het omgevingsplan binnen een warmtetransitiegebied aanwijzen en begrenzen van en stellen van regels over een gebied waar een warmtenet de voorgeschreven energie-infrastructuur is.",
            toelichting="",
            bron="",
            domein="http://standaarden.omgevingswet.overheid.nl/id/conceptscheme/Functie",
            deprecated=False,
